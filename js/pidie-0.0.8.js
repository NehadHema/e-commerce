...
class Pidie {
    ...
    countries() {
      return [
        { id: 'AF', name: 'Afghanistan', currency_code: 'AFN', currency_name: 'Afghani', phone: '+93', language_code: 'ps', language_name: 'Ù¾ÚšØªÙˆ', demonym: 'Afghan' }, 
        { id: 'AL', name: 'Albania', currency_code: 'ALL', currency_name: 'Lek', phone: '+355', language_code: 'sq', language_name: 'Shqip', demonym: 'Albanian' }, 
        { id: 'DZ', name: 'Algeria', currency_code: 'DZD', currency_name: 'Dinar', phone: '+213', language_code: 'ar', language_name: 'Ø§Ù„Ø¹Ø±Ø¨ÙŠØ©', demonym: 'Algerian' }, 
        { id: 'AD', name: 'Andorra', currency_code: 'EUR', currency_name: 'Euro', phone: '+376', language_code: 'ca', language_name: 'CatalÃ ', demonym: 'Andorran' }, 
        { id: 'AO', name: 'Angola', currency_code: 'AOA', currency_name: 'Kwanza', phone: '+244', language_code: 'pt', language_name: 'PortuguÃªs', demonym: 'Angolan' }, 
        ...
        { id: 'AR', name: 'Argentina', currency_code: 'ARS', currency_name: 'Peso', phone: '+54', language_code: 'es', language_name: 'EspaÃ±ol', demonym: 'Argentinian' }, 
        { id: 'AM', name: 'Armenia', currency_code: 'AMD', currency_name: 'Dram', phone: '+374', language_code: 'hy', language_name: 'Õ€Õ¡ÕµÕ¥Ö€Õ¥Õ¶', demonym: 'Armenian' }, 
        ...
        { id: 'AZ', name: 'Azerbaijan', currency_code: 'AZN', currency_name: 'Manat', phone: '+994', language_code: 'az', language_name: 'AzÉ™rbaycan dili', demonym: 'Azerbaijani' }, 
        ...
        { id: 'BH', name: 'Bahrain', currency_code: 'BHD', currency_name: 'Dinar', phone: '+973', language_code: 'ar', language_name: 'Ø§Ù„Ø¹Ø±Ø¨ÙŠØ©', demonym: 'Bahraini' }, 
        { id: 'BD', name: 'Bangladesh', currency_code: 'BDT', currency_name: 'Taka', phone: '+880', language_code: 'bn', language_name: 'à¦¬à¦¾à¦‚à¦²à¦¾', demonym: 'Bengali' }, 
        ...
        { id: 'BY', name: 'Belarus', currency_code: 'BYR', currency_name: 'Ruble', phone: '+375', language_code: 'be', language_name: 'Ð±ÐµÐ»Ð°Ñ€ÑƒÑÐºÐ°Ñ Ð¼Ð¾Ð²Ð°', demonym: 'Belarusian' }, 
        ...
        { id: 'BJ', name: 'Benin', currency_code: 'XOF', currency_name: 'West Africa Franc', phone: '+229', language_code: 'fr', language_name: 'FranÃ§ais', demonym: 'Beninois' }, 
        ...
        { id: 'BO', name: 'Bolivia', currency_code: 'BOB', currency_name: 'Boliviano', phone: '+591', language_code: 'es', language_name: 'EspaÃ±ol', demonym: 'Bolivian' }, 
        ...
        { id: 'BR', name: 'Brazil', currency_code: 'BRL', currency_name: 'Real', phone: '+55', language_code: 'pt', language_name: 'PortuguÃªs', demonym: 'Brazilian' }, 
        ...
        { id: 'BG', name: 'Bulgaria', currency_code: 'BGN', currency_name: 'Lev', phone: '+359', language_code: 'bg', language_name: 'Ð±ÑŠÐ»Ð³Ð°Ñ€ÑÐºÐ¸ ÐµÐ·Ð¸Ðº', demonym: 'Bulgarian' }, 
        { id: 'BF', name: 'Burkina Faso', currency_code: 'XOF', currency_name: 'West Africa Franc', phone: '+226', language_code: 'fr', language_name: 'FranÃ§ais', demonym: 'Burkinabe' }, 
        { id: 'BI', name: 'Burundi', currency_code: 'BIF', currency_name: 'Franc', phone: '+257', language_code: 'fr', language_name: 'FranÃ§ais', demonym: 'Burundian' }, 
        { id: 'KH', name: 'Cambodia', currency_code: 'KHR', currency_name: 'Riel', phone: '+855', language_code: 'km', language_name: 'áž—áž¶ážŸáž¶ážáŸ’áž˜áŸ‚ážš', demonym: 'Cambodian' }, 
        { id: 'CM', name: 'Cameroon', currency_code: 'XAF', currency_name: 'Central African Franc', phone: '+237', language_code: 'fr', language_name: 'FranÃ§ais', demonym: 'Cameroonian' }, 
        { id: 'CA', name: 'Canada', currency_code: 'CAD', currency_name: 'Dollar', phone: '+1', language_code: 'en', language_name: 'English', demonym: 'Canadian' }, 
        { id: 'CV', name: 'Cape Verde', currency_code: 'CVE', currency_name: 'Escudo', phone: '+238', language_code: 'pt', language_name: 'PortuguÃªs', demonym: 'Cape Verdean' }, 
        { id: 'CF', name: 'Central African Republic', currency_code: 'XAF', currency_name: 'Franc', phone: '+236', language_code: 'fr', language_name: 'FranÃ§ais', demonym: 'Central African' }, 
        { id: 'TD', name: 'Chad', currency_code: 'XAF', currency_name: 'Central African Franc', phone: '+235', language_code: 'fr', language_name: 'FranÃ§ais', demonym: 'Chadian' }, 
        { id: 'CL', name: 'Chile', currency_code: 'CLP', currency_name: 'Peso', phone: '+56', language_code: 'es', language_name: 'EspaÃ±ol', demonym: 'Chilean' }, 
        { id: 'CN', name: 'China', currency_code: 'CNY', currency_name: 'Yuan', phone: '+86', language_code: 'zh', language_name: 'åŽè¯­', demonym: 'Chinese' }, 
        { id: 'CO', name: 'Colombia', currency_code: 'COP', currency_name: 'Peso', phone: '+57', language_code: 'es', language_name: 'EspaÃ±ol', demonym: 'Colombian' }, 
        { id: 'KM', name: 'Comoros', currency_code: 'KMF', currency_name: 'Franc', phone: '+269', language_code: 'fr', language_name: 'FranÃ§ais', demonym: 'Comorian' }, 
        { id: 'CD', name: 'Democratic Congo', currency_code: 'CDF', currency_name: 'Franc', phone: '+243', language_code: 'fr', language_name: 'FranÃ§ais', demonym: 'Congolese' }, 
        { id: 'CG', name: 'Congo', currency_code: 'XAF', currency_name: 'Central African Franc', phone: '+242', language_code: 'fr', language_name: 'FranÃ§ais', demonym: 'Congolese' }, 
        { id: 'CR', name: 'Costa Rica', currency_code: 'CRC', currency_name: 'ColÃ³n', phone: '+506', language_code: 'es', language_name: 'EspaÃ±ol', demonym: 'Costa Rican' }, 
        ...
        { id: 'CU', name: 'Cuba', currency_code: 'CUC', currency_name: 'Convertible Peso', phone: '+53', language_code: 'es', language_name: 'EspaÃ±ol', demonym: 'Cuban' }, 
        { id: 'CY', name: 'Cyprus', currency_code: 'EUR', currency_name: 'Euro', phone: '+357', language_code: 'el', language_name: 'ÎµÎ»Î»Î·Î½Î¹ÎºÎ¬', demonym: 'Cypriot' }, 
        { id: 'CZ', name: 'Czech Republic', currency_code: 'CZK', currency_name: 'Koruna', phone: '+420', language_code: 'cs', language_name: 'ÄeÅ¡tina', demonym: 'Czech' }, 
        { id: 'DK', name: 'Denmark', currency_code: 'DKK', currency_name: 'Krone', phone: '+45', language_code: 'da', language_name: 'Dansk', demonym: 'Danish' }, 
        { id: 'DJ', name: 'Djibouti', currency_code: 'DJF', currency_name: 'Franc', phone: '+253', language_code: 'fr', language_name: 'FranÃ§ais', demonym: 'Djiboutian' }, 
        ...
        { id: 'DO', name: 'Dominican Republic', currency_code: 'DOP', currency_name: 'Peso', phone: '+1849', language_code: 'es', language_name: 'EspaÃ±ol', demonym: 'Dominican' }, 
        { id: 'TL', name: 'East Timor', currency_code: 'USD', currency_name: 'United States Dollar', phone: '+670', language_code: 'pt', language_name: 'PortuguÃªs', demonym: 'East Timorese' }, 
        { id: 'EC', name: 'Ecuador', currency_code: 'USD', currency_name: 'United States Dollar', phone: '+593', language_code: 'es', language_name: 'EspaÃ±ol', demonym: 'Ecuadorian' }, 
        { id: 'EG', name: 'Egypt', currency_code: 'EGP', currency_name: 'Pound', phone: '+20', language_code: 'ar', language_name: 'Ø§Ù„Ø¹Ø±Ø¨ÙŠØ©', demonym: 'Egyptian' }, 
        { id: 'SV', name: 'El Salvador', currency_code: 'USD', currency_name: 'United States Dollar', phone: '+503', language_code: 'es', language_name: 'EspaÃ±ol', demonym: 'Salvadoran' }, 
        { id: 'GQ', name: 'Equatorial Guinea', currency_code: 'XAF', currency_name: 'Central African Franc', phone: '+240', language_code: 'es', language_name: 'EspaÃ±ol', demonym: 'Equatoguinean' }, 
        ...
        { id: 'ET', name: 'Ethiopia', currency_code: 'ETB', currency_name: 'Birr', phone: '+251', language_code: 'am', language_name: 'áŠ áˆ›áˆ­áŠ›', demonym: 'Ethiopian' }, 
        ...
        { id: 'FR', name: 'France', currency_code: 'XPF', currency_name: 'Franc', phone: '+33', language_code: 'fr', language_name: 'FranÃ§ais', demonym: 'French' }, 
        { id: 'GA', name: 'Gabon', currency_code: 'XAF', currency_name: 'Central African Franc', phone: '+241', language_code: 'fr', language_name: 'FranÃ§ais', demonym: 'Gabonaise' }, 
        ...
        { id: 'GE', name: 'Georgia', currency_code: 'GEL', currency_name: 'Lari', phone: '+995', language_code: 'ka', language_name: 'áƒ¥áƒáƒ áƒ—áƒ£áƒšáƒ˜', demonym: 'Georgian' }, 
        ...
        { id: 'GR', name: 'Greece', currency_code: 'EUR', currency_name: 'Euro', phone: '+30', language_code: 'el', language_name: 'ÎµÎ»Î»Î·Î½Î¹ÎºÎ¬', demonym: 'Greek' }, 
        ...
        { id: 'GT', name: 'Guatemala', currency_code: 'GTQ', currency_name: 'Quetzal', phone: '+502', language_code: 'es', language_name: 'EspaÃ±ol', demonym: 'Guatemalan' }, 
        { id: 'GN', name: 'Guinea', currency_code: 'GNF', currency_name: 'Franc', phone: '+224', language_code: 'fr', language_name: 'FranÃ§ais', demonym: 'Guinean' }, 
        { id: 'GW', name: 'Guinea-Bissau', currency_code: 'XOF', currency_name: 'West African Franc', phone: '+245', language_code: 'pt', language_name: 'PortuguÃªs', demonym: 'Bissau-Guinean' }, 
        ...
        { id: 'HT', name: 'Haiti', currency_code: '', currency_name: 'Gourde', phone: '+509', language_code: 'fr', language_name: 'FranÃ§ais', demonym: 'Haitian' }, 
        { id: 'HN', name: 'Honduras', currency_code: 'HNL', currency_name: 'Lempira', phone: '+504', language_code: 'es', language_name: 'EspaÃ±ol', demonym: 'Honduran' }, 
        ...
        { id: 'IS', name: 'Iceland', currency_code: 'ISK', currency_name: 'KrÃ³na', phone: '+354', language_code: 'is', language_name: 'Ã­slenska', demonym: 'Icelandic' }, 
        { id: 'IN', name: 'India', currency_code: 'INR', currency_name: 'Rupee', phone: '+91', language_code: 'hi', language_name: 'à¤¹à¤¿à¤¨à¥à¤¦à¥€', demonym: 'Indian' }, 
        ...
        { id: 'IR', name: 'Iran', currency_code: 'IRR', currency_name: 'Rial', phone: '+98', language_code: 'fa', language_name: 'ÙØ§Ø±Ø³ÛŒ', demonym: 'Iranian' }, 
        { id: 'IQ', name: 'Iraq', currency_code: 'IQD', currency_name: 'Dinar', phone: '+964', language_code: 'ar', language_name: 'Ø§Ù„Ø¹Ø±Ø¨ÙŠØ©', demonym: 'Iraqi' }, 
        { id: 'IE', name: 'Ireland', currency_code: 'EUR', currency_name: 'Euro', phone: '+353', language_code: 'en', language_name: 'English', demonym: '	Irish' }, 
        { id: 'IL', name: 'Israel', currency_code: 'ILS', currency_name: 'New Shekel', phone: '	+972', language_code: 'he', language_name: '×¢Ö´×‘Ö°×¨Ö´×™×ª', demonym: 'Israeli' }, 
        { id: 'IT', name: 'Italy', currency_code: 'EUR', currency_name: 'Euro', phone: '+39', language_code: 'it', language_name: 'Italiano', demonym: 'Italian' }, 
        { id: 'CI', name: 'Ivory Coast', currency_code: 'XOF', currency_name: 'West African Franc', phone: '+225', language_code: 'fr', language_name: 'FranÃ§ais', demonym: 'Ivorian' },
        ...
        { id: 'JP', name: 'Japan', currency_code: 'JPY', currency_name: 'Yen', phone: '', language_code: 'ja', language_name: 'æ—¥æœ¬èªž', demonym: 'Japanese' },
        { id: 'JO', name: 'Jordan', currency_code: 'JOD', currency_name: 'Dinar', phone: '+962', language_code: 'ar', language_name: 'Ø§Ù„Ø¹Ø±Ø¨ÙŠØ©', demonym: 'Jordanian' },
        ...
        { id: 'KP', name: 'North Korea', currency_code: 'KPW', currency_name: 'Won', phone: '+850', language_code: 'ko', language_name: 'ì¡°ì„ ì–´', demonym: 'North Korean' },
        { id: 'KR', name: 'South Korea', currency_code: 'KRW', currency_name: 'Won', phone: '+82', language_code: 'ko', language_name: 'í•œêµ­ì–´', demonym: 'South Korean' },
        { id: 'KW', name: 'Kuwait', currency_code: 'KWD', currency_name: 'Dinar', phone: '+965', language_code: 'ar', language_name: 'Ø§Ù„Ø¹Ø±Ø¨ÙŠØ©', demonym: 'Kuwaiti' },
        { id: 'KG', name: 'Kyrgyzstan', currency_code: 'KGS', currency_name: 'Som', phone: '+996', language_code: '	ky', language_name: 'Kyrgyz', demonym: 'Kyrgyz' },
        { id: 'LA', name: 'Laos', currency_code: 'LAK', currency_name: 'Kip', phone: '+856', language_code: 'lo', language_name: 'àºžàº²àºªàº²àº¥àº²àº§', demonym: 'Laotian' },
        { id: 'LV', name: 'Latvia', currency_code: 'EUR', currency_name: 'Euro', phone: '+371', language_code: 'lv', language_name: 'LatvieÅ¡u Valoda', demonym: 'Latvian' },
        { id: 'LB', name: 'Lebanon', currency_code: 'LBP', currency_name: 'Pound', phone: '+961', language_code: 'ar', language_name: 'Ø§Ù„Ø¹Ø±Ø¨ÙŠØ©', demonym: 'Lebanese' },
        ...
        { id: 'LY', name: 'Libya', currency_code: 'LYD', currency_name: 'Dinar', phone: '+	218', language_code: 'ar', language_name: 'Ø§Ù„Ø¹Ø±Ø¨ÙŠØ©', demonym: 'Libyan' },
        ...
        { id: 'LT', name: 'Lithuania', currency_code: 'EUR', currency_name: 'Euro', phone: '+370', language_code: 'lt', language_name: 'LietuviÅ³ kalba', demonym: 'Lithuanian' },
        { id: 'LU', name: 'Luxembourg', currency_code: 'EUR', currency_name: 'Euro', phone: '+352', language_code: 'lb', language_name: 'LÃ«tzebuergesch', demonym: 'Luxembourg' },
    ...
    quotesSlideshow() {
      ...
      prevQuotes.innerHTML = 'â®';
      nextQuotes.innerHTML = 'â¯';
    ...
    titleLink() {
      ...
      var separator = '-';
      var special = {  
        Ä…:"a",Ä„:"A",Ä™:"e",Ä˜:"E",Ã³:"o",Ã“:"O",Å›:"s",Åš:"S",Å‚:"l",Å:"L",
        Å¼:"z",Å»:"Z",Åº:"z",Å¹:"Z",Ä‡:"c",Ä†:"C",Å„:"n",Åƒ:"N",Ä:"c",Ä:"d",
        Åˆ:"n",Å™:"r",Å¡:"s",Å¥:"t",Å :"S",Å’:"O",Å½:"Z",Å¡:"s",Å“:"o",Å¾:"z",
        Å¸:"Y",Ã¿:"y",Âµ:"U",Ã€:"A",Ã:"A",Ã‚:"A",Ãƒ:"A",Ã„:"A",Ã…:"A",Ã†:"A",
        Ã‡:"C",Ãˆ:"E",Ã‰:"E",ÃŠ:"E",Ã‹:"E",ÃŒ:"I",Ã:"I",ÃŽ:"I",Ã:"I",Ã:"D",
        Ã‘:"N",Ã’:"O",Ã”:"O",Ã•:"O",Ã–:"O",Ã˜:"O",Ã™:"U",Ãš:"U",Ã›:"U",Ãœ:"U",
        Ã:"Y",ÃŸ:"s",Ã :"a",Ã¡:"a",Ã¢:"a",Ã£:"a",Ã¤:"a",Ã¥:"a",Ã¦:"a",Ã§:"c",
        Ã¨:"e",Ã©:"e",Ãª:"e",Ã«:"e",Ã¬:"i",Ã­:"i",Ã®:"i",Ã¯:"i",Ã°:"o",Ã±:"n",
        Ã²:"o",Ã´:"o",Ãµ:"o",Ã¶:"o",Ã¸:"o",Ã¹:"u",Ãº:"u",Ã»:"u",Ã¼:"u",Ã½:"y",
        'Â¥':"Y",'&':"and"
      }
      var max = '';
